class ActionCodeLockLock: ActionContinuousBase
{
	void ActionCodeLockLock()
	{
	...
	override bool ActionCondition(PlayerBase player, ActionTarget target, ItemBase item)
	{
		...
		return code_lock.IsAuthorized(player.GetIdentity()) && code_lock.GetState() == CodeLockState.UNLOCKED;
	}
	...
	override void OnFinishProgressServer(ActionData action_data)
	{
		...
		code_lock.SetState(CodeLockState.LOCKED);
	}
}