...
class CfgVehicles
{
	...
	class TerritoryHQ: Container_Base
	{
		...
		hiddenSelectionsTextures[] = {"RearmedServer\BaseBuilding\Data\Images\Computer_logos_co.paa"};
	...
	class RA_BoxKit_Base: Container_Base
	{
		...
		hiddenSelectionsTextures[] = {"RearmedServer\BaseBuilding\Data\Images\carrierbox_applekz_co.paa"};
	};
