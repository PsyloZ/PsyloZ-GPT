class CfgPatches
{
	class BaseBuilding_Ramp
	{
		...
		units[]=
		{
			...
			"BaseBuilding_FrameRamp",
			"BaseBuilding_WoodRamp"
		};
		weapons[]={};
	};
};
class CfgVehicles
{
	...
	{
		displayName="Ramp";
		displayIcon="set:BaseBuilding_Icons image:Ramp";
		placementMode=2;
		stabilityNode=1;
		class Snapping
		{
	...
	class BaseBuilding_HologramRamp: BaseBuilding_RampBase
	{
		scope=2;
		model="RearmedServer\BaseBuilding\Ramp\HologramRamp.p3d";
		materialLevel=0;
		upgradeType="BaseBuilding_FrameRamp";
		hiddenSelections[]=
		{
			"wood"
		};
	...
	{
		scope=2;
		descriptionShort="A weird lookin frame ramp";
		model="RearmedServer\BaseBuilding\Ramp\FrameRamp.p3d";
		materialLevel=1;
		upgradeType="BaseBuilding_WoodRamp";
		hiddenSelections[]=
		{
			"wood"
		};
	...
	{
		scope=2;
		descriptionShort="A constructed wooden ramp";
		model="RearmedServer\BaseBuilding\Ramp\WoodRamp.p3d";
		materialLevel=2;
		hiddenSelections[]=
		{
			"wood"
