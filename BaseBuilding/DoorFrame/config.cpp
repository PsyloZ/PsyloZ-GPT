class CfgPatches
{
	class BaseBuilding_DoorFrame
	{
		...
		units[]=
		{
			...
			"BaseBuilding_FrameDoorFrame",
			"BaseBuilding_WoodDoorFrame",
			"BaseBuilding_MetalDoorFrame",
			"BaseBuilding_ConcreteDoorFrame"
		};
		weapons[]={};
	};
};
class CfgVehicles
{
	...
	class BaseBuilding_HologramDoorFrame: BaseBuilding_DoorFrameBase
	{
		scope=2;
		model="RearmedServer\BaseBuilding\DoorFrame\HologramDoorFrame.p3d";
		materialLevel=0;
		upgradeType="BaseBuilding_FrameDoorFrame";
		hiddenSelections[]=
		{
			"wood"
		};
	...
	{
		scope=2;
		model="RearmedServer\BaseBuilding\DoorFrame\FrameDoorFrame.p3d";
	...
	{
		scope=2;
		model="RearmedServer\BaseBuilding\DoorFrame\WoodDoorFrame.p3d";
		upgradeType="BaseBuilding_MetalDoorFrame";
		attachments[]=
		{
			"CamoNet"
		};
		...
		hiddenSelectionsTextures[]=
		{
			"rearmedserver\basebuilding\materials\wood\data\DoorWall_planks_co.paa",
			"dz\gear\consumables\data\pile_of_planks_co.paa"
		};
		materialLevel=2;
		class DamageSystem
				...
				class Health
				{
					...
					healthLevels[]=
					{
						
						{
							...
							{
								"rearmedserver\basebuilding\materials\wood\data\DoorWall_planks.rvmat",
								"RearmedServer\BaseBuilding\Materials\Wood\data\RA_pile_of_planks.rvmat"
							}
						},
						
						{
							...
							{
								"rearmedserver\basebuilding\materials\wood\data\DoorWall_planks_damage.rvmat",
								"RearmedServer\BaseBuilding\Materials\Wood\data\RA_pile_of_planks_damage.rvmat"
							}
						},
						...
						
						{
							...
							{
								"rearmedserver\basebuilding\materials\wood\data\DoorWall_planks_destruct.rvmat",
								"RearmedServer\BaseBuilding\Materials\Wood\data\RA_pile_of_planks_destruct.rvmat"
							}
						},
	...
	{
		scope=2;
		model="RearmedServer\BaseBuilding\DoorFrame\MetalDoorFrame.p3d";
		materialLevel=3;
		upgradeType="BaseBuilding_ConcreteDoorFrame";
		attachments[]=
		{
			"CamoNet"
		};
		...
		{
			"dz\gear\consumables\data\pile_of_planks_co.paa",
			"RearmedServer\BaseBuilding\Materials\Metal\data\Metal_DoorFrame_co.paa",
				...
				class Health
				{
					...
					healthLevels[]=
					{
						
						{
							...
							{
								"RearmedServer\BaseBuilding\Materials\Wood\data\RA_pile_of_planks.rvmat",
								"RearmedServer\BaseBuilding\Materials\Metal\data\Metal_DoorFrame.rvmat",
						...
						
						{
							...
							
							{
								...
								"RearmedServer\BaseBuilding\Materials\Metal\data\Metal_DoorFrame_damage.rvmat",
						...
						
						{
							...
							
							{
								...
								"RearmedServer\BaseBuilding\Materials\Metal\data\Metal_DoorFrame_destruct.rvmat",
	...
	{
		scope=2;
		model="RearmedServer\BaseBuilding\DoorFrame\ConcreteDoorFrame.p3d";
		materialLevel=4;
		attachments[]=
		{
			"CamoNet"
