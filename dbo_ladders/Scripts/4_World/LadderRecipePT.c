class LadderRecipePT extends RecipeBase   // Our example recipe which uses primary ingredient - our custom item MagicHammer to turn any other secondary ingredient ( all ItemBase items ) into stones. 
{
	
	override void Init()
	{
		
		m_Name = "CreateLadderSection";	// action name in game
		...
		//ingredient 1  
		InsertIngredient(0,"dbo_ladderPART");	// primary ingredient
		...
		//ingredient 2	
		InsertIngredient(1,"dbo_ladderPART"); //  secondary ingredient
		...
		//result
		AddResult("dbo_ladderP");	// recipe result
