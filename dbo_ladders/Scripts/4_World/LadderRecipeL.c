class LadderRecipeL extends RecipeBase   // Our example recipe which uses primary ingredient - our custom item MagicHammer to turn any other secondary ingredient ( all ItemBase items ) into stones. 
{
	
	override void Init()
	{
		
		m_Name = "CreateLargeLadder";	// action name in game
		...
		//ingredient 1  
		InsertIngredient(0,"dbo_ladderP");	// primary ingredient
		...
		//ingredient 2	
		InsertIngredient(1,"dbo_ladderP"); //  secondary ingredient
		...
		//result
		AddResult("land_dbo_ladder_L");	// recipe result
