class PurpleHelmetsLootCrate: ZLandContainerBase
{
	override void RegisterLootTable(array<ref ZLandLootEntry> loot_table) 
	{
		...
		loot_table.Insert(new ZLandLootEntry({"IMP_Helmet_RoninHeavy_Black","IMP_Helmet_RoninHeavy_Green","ZLANDk6Helmet_Green","ZLANDk6Helmet_Black","IMP_Helmet_Silencer_Black","IMP_Helmet_Silencer_Green","ZLANDKSHHelmet_BlackKilla","ZLANDKSHHelmet_Black","ZLANDKSHHelmet_Green"}, 0.5));
		loot_table.Insert(new ZLandLootWithAttachments({"ZLand"}, 0, {
