class DuffleLootCrate_HighTier_Livonia: ZLandContainerBase
{
	override void RegisterLootTable(array<ref ZLandLootEntry> loot_table) 
	{
		...
		loot_table.Insert(new ZLandLootEntry({"HDSN_BreachingCharge"}, 0.2));
		loot_table.Insert(new ZLandLootWithAttachments({"ZLand"}, 0, {
	
		}));
		loot_table.Insert(new ZLandLootEntry({"HDSN_BreachingChargeHeavy"}, 0.1));
		loot_table.Insert(new ZLandLootWithAttachments({"ZLand"}, 0, {
		...
		loot_table.Insert(new ZLandLootEntry({"ZLand_RedRoomArmoryKey_Livonia"}, 0.25));
		loot_table.Insert(new ZLandLootWithAttachments({"ZLand"}, 0, {
	
		}));
		loot_table.Insert(new ZLandLootEntry({"ZLAND_WorkBench_TableSaw"}, 0.25));
		loot_table.Insert(new ZLandLootWithAttachments({"ZLand"}, 0, {
	
		}));
		loot_table.Insert(new ZLandLootEntry({"ZLAND_WorkBench_Grinder"}, 0.25));
		loot_table.Insert(new ZLandLootWithAttachments({"ZLand"}, 0, {

		}));
		loot_table.Insert(new ZLandLootEntry({"ZLAND_WorkBench_Kit"}, 0.25));
		loot_table.Insert(new ZLandLootWithAttachments({"ZLand"}, 0, {
