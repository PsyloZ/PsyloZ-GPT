	...
	override void RegisterLootTable(array<ref ZLandLootEntry> loot_table) 
	{
		...
		loot_table.Insert(new ZLandLootWithAttachments({"Connor_CZ805"}, 1.0, {
			...
			new ZLandLootWithAttachments({"Connor_CZ805_Magazine"}, 1.0, {
				new ZLandLootEntry({"Battery9V", "VTR_bravo4","Connor_Bravo","Connor_Burris","Connor_Holosun","Connor_PK06","Connor_Romeo3","Connor_Spitfire","ZLand_Hamr","ZLand_DeltaPoint","Connor_CZ805_Magazine"}),
			}),
		}));
		loot_table.Insert(new ZLandLootEntry({"ZLand"}, 0));
		...
		loot_table.Insert(new ZLandLootWithAttachments({"ZLand_ASVAL"}, 1.0, {
			new ZLandLootEntry({"ZLand_CobraForeGrip","ZLand_DeltaPoint","Connor_Bravo","Connor_Burris","Connor_Elcan","Connor_PK06","Connor_TrijiconMRO"}),
			new ZLandLootEntry({"ZLand_CombatGrip","ZLand_CobraForeGrip","ZLand_ShiftGrip","ZLand_StubbyGrip","ZLand_ZenithGrip","ProjectForeGrip_Black"}),
		...
		loot_table.Insert(new ZLandLootWithAttachments({"ZLand_SVD"}, 1.0, {
			new ZLandLootEntry({"A6_VortexRazorOptic"}),
			new ZLandLootEntry({"ZLand_CobraForeGrip","ZLand_ShiftGrip","ZLand_StubbyGrip","ZLand_ZenithGrip","ProjectForeGrip_Black"}),
		...
		loot_table.Insert(new ZLandLootEntry({"ZLand"}, 0));
		loot_table.Insert(new ZLandLootWithAttachments({"ZLandMP5"}, 1.0, {
			new ZLandLootEntry({"VTR_bravo4","ZLand_DeltaPoint","Connor_Bravo","Connor_Burris","Connor_Elcan","Connor_PK06","Connor_TrijiconMRO"}),
			new ZLandLootEntry({"ZLand_CombatGrip","ZLand_CobraForeGrip","ZLand_ShiftGrip","ZLand_StubbyGrip","ZLand_ZenithGrip","ProjectForeGrip_Black"}),
			new ZLandLootWithAttachments({"ZLandMP5Drum_Magazine"}, 1.0, {
				new ZLandLootEntry({"Battery9V"}),
			}),
		}));
		loot_table.Insert(new ZLandLootEntry({"ZLand"}, 0));
		loot_table.Insert(new ZLandLootWithAttachments({"ZLand_ARX160"}, 1.0, {
			...
			new ZLandLootWithAttachments({"ZLand_ARX160_Mag_30rnd"}, 1.0, {
				new ZLandLootEntry({"VTR_bravo4","Connor_Elcan","Connor_Bravo","Connor_Burris","Connor_Holosun","Connor_PK06","Connor_Romeo3","Connor_Spitfire","ZLand_Hamr","ZLand_DeltaPoint","Connor_CZ805_Magazine"}),
			}),
		}));
		loot_table.Insert(new ZLandLootEntry({"ZLand"}, 0));
		loot_table.Insert(new ZLandLootWithAttachments({"Connor_MK18"}, 1.0, {
			...
			new ZLandLootWithAttachments({"ConnorMK18_Magazine"}, 1.0, {
				new ZLandLootEntry({"Battery9V","Connor_Elcan","Connor_Bravo","Connor_Burris","Connor_Holosun","Connor_PK06","Connor_Romeo3","Connor_Spitfire","ZLand_Hamr","ZLand_DeltaPoint","Connor_CZ805_Magazine"}),
			}),
		}));
		loot_table.Insert(new ZLandLootEntry({"ZLand"}, 0));
		loot_table.Insert(new ZLandLootWithAttachments({"PITSTOP_SCARH_Black"}, 1.0, {
			...
			new ZLandLootWithAttachments({"PITSTOP_SCARH_50rnd_Magazine"}, 1.0, {
				new ZLandLootEntry({"Battery9V", "VTR_bravo4","Connor_Bravo","Connor_Burris","Connor_Holosun","Connor_PK06","Connor_Romeo3","Connor_Spitfire","ZLand_Hamr","ZLand_DeltaPoint","PITSTOP_SCARH_50rnd_Magazine"}),
			}),
		}));
		loot_table.Insert(new ZLandLootEntry({"ZLand"}, 0));
		loot_table.Insert(new ZLandLootWithAttachments({"ZLand_SA58"}, 1.0, {
			...
			new ZLandLootWithAttachments({"ZLandSA58_Magazine"}, 1.0, {
				new ZLandLootEntry({"Battery9V", "VTR_bravo4","Connor_Bravo","Connor_Burris","Connor_Holosun","Connor_PK06","Connor_Romeo3","Connor_Spitfire","ZLand_Hamr","ZLand_DeltaPoint","ZLandSA58_Magazine"}),
			}),
		}));
		loot_table.Insert(new ZLandLootEntry({"ZLand"}, 0));
		loot_table.Insert(new ZLandLootWithAttachments({"PITSTOP_HK417_Black"}, 1.0, {
		...
		loot_table.Insert(new ZLandLootWithAttachments({"ZLand_AK47"}, 1.0, {
			...
			new ZLandLootWithAttachments({"ZLand_AK47_Magazine"}, 1.0, {
			    new ZLandLootEntry({"Battery9V", "VTR_bravo4", "Connor_Elcan","Connor_Bravo","Connor_Burris","Connor_Holosun","Connor_PK06","Connor_Romeo3","Connor_Spitfire","ZLand_Hamr","ZLand_DeltaPoint","ZLand_AK47_Magazine"}),
			}),
		}));
		loot_table.Insert(new ZLandLootEntry({"zland"}, 0));
		loot_table.Insert(new ZLandLootWithAttachments({"ZLand_MK3"}, 0.3, {
			new ZLandLootEntry({"ZLand_Burris_RT6","Atlas_Bipod"}),
			new ZLandLootEntry({"ZLand_CombatGrip","ZLand_CobraForeGrip","ZLand_ShiftGrip","ZLand_StubbyGrip","ZLand_ZenithGrip","ProjectForeGrip_Black"}),
			new ZLandLootWithAttachments({"ZLandMk3_Magazine"}, 1.0, {
			    new ZLandLootEntry({"Battery9V","APES_Mildot","APES_shinigamired","APES_Shinigami_V2_Red","APES_Shortdotred","APES_Hunting_Red","ZLandMK3_Magazine"}),
			}),
		}));
		loot_table.Insert(new ZLandLootEntry({"ZLand"}, 0));
		...
		loot_table.Insert(new ZLandLootWithAttachments({"ZLand_SKW338"}, 0.3, {
			...
			new ZLandLootWithAttachments({"ZLandSKW338_Magazine"}, 1.0, {
			    new ZLandLootEntry({"Battery9V","APES_Mildot","APES_shinigamired","APES_Shinigami_V2_Red","APES_Shortdotred","APES_Hunting_Red","ZLandSKW338_Magazine"}),
			}),
		}));
		loot_table.Insert(new ZLandLootEntry({"ZLand"}, 0));
		loot_table.Insert(new ZLandLootWithAttachments({"ZLand_Tac21"}, 1.0, {
			...
			new ZLandLootWithAttachments({"ZLandTac21_Magazine"}, 1.0, {
			    new ZLandLootEntry({"Battery9V","APES_Mildot","APES_shinigamired","APES_Shinigami_V2_Red","APES_Shortdotred","APES_Hunting_Red","ZLandTac21_Magazine"}),
			}),
		}));
		loot_table.Insert(new ZLandLootEntry({"ZLand"}, 0));
		loot_table.Insert(new ZLandLootWithAttachments({"PITSTOP_Ruger_Black"}, 1.0, {
			...
			new ZLandLootWithAttachments({"PITSTOP_Ruger_Magazine"}, 1.0, {
			    new ZLandLootEntry({"Battery9V","APES_Mildot","APES_shinigamired","APES_Shinigami_V2_Red","APES_Shortdotred","APES_Hunting_Red","PITSTOP_Ruger_Black"}),
			}),
		}));
		loot_table.Insert(new ZLandLootEntry({"ZLand"}, 0));
		loot_table.Insert(new ZLandLootWithAttachments({"ZLand_TIMBERWOLF"}, 1.0, {
			...
			new ZLandLootWithAttachments({"ZLandTIMBERWOLF_Magazine"}, 1.0, {
			    new ZLandLootEntry({"Battery9V","APES_Mildot","APES_shinigamired","APES_Shinigami_V2_Red","APES_Shortdotred","APES_Hunting_Red","ZLandTIMBERWOLF_Magazine"}),
			}),
		}));
		loot_table.Insert(new ZLandLootEntry({"ZLand"}, 0));
		loot_table.Insert(new ZLandLootWithAttachments({"PITSTOP_M10_Black"}, 0.5, {
			new ZLandLootEntry({"ZLand_Burris_RT6"}),
			new ZLandLootEntry({"Atlas_Bipod"}),
			new ZLandLootWithAttachments({"PITSTOP_M10_Magazine"}, 1.0, {
			    new ZLandLootEntry({"Battery9V","APES_Mildot","APES_shinigamired","APES_Shinigami_V2_Red","APES_Shortdotred","APES_Hunting_Red","PITSTOP_M10_Magazine"}),
			}),
		}));
		loot_table.Insert(new ZLandLootEntry({"ZLand"}, 0));
		loot_table.Insert(new ZLandLootWithAttachments({"PITSTOP_M1000X_Black"}, 0.1, {
			...
			new ZLandLootWithAttachments({"PITSTOP_M1000X_Magazine"}, 1.0, {
			    new ZLandLootEntry({"Battery9V","APES_Mildot","APES_shinigamired","APES_Shinigami_V2_Red","APES_Shortdotred","APES_Hunting_Red","PITSTOP_M1000X_Magazine"}),
			}),
		}));
		loot_table.Insert(new ZLandLootEntry({"ZLand"}, 0));
		loot_table.Insert(new ZLandLootWithAttachments({"ZLand_SRSA2"}, 1.0, {
			...
			new ZLandLootWithAttachments({"SRSA2_Mag_10rnd"}, 1.0, {
			    new ZLandLootEntry({"Battery9V","APES_Mildot","APES_shinigamired","APES_Shinigami_V2_Red","APES_Shortdotred","APES_Hunting_Red","Connor_Vortex3","SRSA2_Mag_10rnd"}),
			}),
		}));
		loot_table.Insert(new ZLandLootEntry({"ZLand"}, 0));
		loot_table.Insert(new ZLandLootWithAttachments({"PITSTOP_Beowulf"}, 1.0, {
			...
			new ZLandLootWithAttachments({"PITSTOP_Beowulf_Magazine"}, 1.0, {
			    new ZLandLootEntry({"Battery9V","VTR_bravo4","APES_shinigamired","APES_Shinigami_V2_Red","APES_Shortdotred","APES_Hunting_Red","PITSTOP_Beowulf_Magazine"}),
			}),
		}));
		loot_table.Insert(new ZLandLootEntry({"ZLand"}, 0));
		loot_table.Insert(new ZLandLootWithAttachments({"ZLand_M300"}, 0.5, {
			new ZLandLootEntry({"ZLand_Burris_RT6"}),
			new ZLandLootEntry({"Atlas_Bipod"}),
			new ZLandLootWithAttachments({"ZLand_M300_Magazine"}, 1.0, {
			    new ZLandLootEntry({"Battery9V","APES_Mildot","APES_shinigamired","APES_Shinigami_V2_Red","APES_Shortdotred","APES_Hunting_Red","ZLand_M300_Magazine"}),
			}),
		}));
		loot_table.Insert(new ZLandLootEntry({"ZLand"}, 0));
		loot_table.Insert(new ZLandLootWithAttachments({"ZLand_M200"}, 0.5, {
			new ZLandLootEntry({"ZLand_Burris_RT6"}),
			new ZLandLootEntry({"ZLand_Burris_RT6"}),
			new ZLandLootWithAttachments({"ZLand_M200_Mag_7rnd"}, 1.0, {
			    new ZLandLootEntry({"Battery9V","APES_Mildot","APES_shinigamired","APES_Shinigami_V2_Red","APES_Shortdotred","APES_Hunting_Red","IMP_Mag_M200_7Rnd"}),
			}),
		}));
		loot_table.Insert(new ZLandLootEntry({"ZLand"}, 0));
		loot_table.Insert(new ZLandLootWithAttachments({"PITSTOP_M240"}, 1.0, {
			...
			new ZLandLootWithAttachments({"PITSTOP_M240_Magazine"}, 1.0, {
			    new ZLandLootEntry({"Battery9V", "VTR_bravo4","Connor_Bravo","Connor_Burris","Connor_Holosun","Connor_PK06","Connor_Romeo3","Connor_Spitfire","ZLand_Hamr","ZLand_DeltaPoint","PITSTOP_M240_Magazine"}),
			}),
		}));
		loot_table.Insert(new ZLandLootEntry({"ZLand"}, 0));
		loot_table.Insert(new ZLandLootWithAttachments({"ZLand_PKM"}, 1.0, {
			...
			new ZLandLootWithAttachments({"ZLand_PKM_Magazine"}, 1.0, {
			    new ZLandLootEntry({"Battery9V", "Connor_Elcan","Connor_Bravo","Connor_Burris","Connor_Holosun","Connor_PK06","Connor_Romeo3","Connor_Spitfire","ZLand_Hamr","ZLand_DeltaPoint","ZLand_PKM_Magazine"}),
			}),
		}));
		loot_table.Insert(new ZLandLootEntry({"ZLand"}, 0));
		loot_table.Insert(new ZLandLootWithAttachments({"PITSTOP_PKP"}, 1.0, {
			...
			new ZLandLootWithAttachments({"PITSTOP_PKP_Magazine"}, 1.0, {
			    new ZLandLootEntry({"Battery9V", "VTR_bravo4","Connor_Bravo","Connor_Burris","Connor_Holosun","Connor_PK06","Connor_Romeo3","Connor_Spitfire","ZLand_Hamr","ZLand_DeltaPoint","PITSTOP_PKP_Magazine"}),
			}),
		}));
		loot_table.Insert(new ZLandLootEntry({"ZLand"}, 0));
		loot_table.Insert(new ZLandLootWithAttachments({"PITSTOP_M96"}, 0.1, {
			...
			new ZLandLootWithAttachments({"PITSTOP_M96_Magazine"}, 1.0, {
			    new ZLandLootEntry({"Battery9V","APES_Mildot","APES_shinigamired","APES_Shinigami_V2_Red","APES_Shortdotred","APES_Hunting_Red","PITSTOP_M96_Magazine"}),
			}),
		}));
		loot_table.Insert(new ZLandLootEntry({"ZLand"}, 0));
		loot_table.Insert(new ZLandLootWithAttachments({"ZLand_AX50"}, 0.1, {
			...
			new ZLandLootWithAttachments({"ZLand_Mag_AX50_5rnd"}, 1.0, {
			    new ZLandLootEntry({"Battery9V","APES_Mildot","APES_shinigamired","APES_Shinigami_V2_Red","APES_Shortdotred","APES_Hunting_Red","PITSTOP_AX50_Magazine"}),
			}),
		}));
		loot_table.Insert(new ZLandLootEntry({"ZLAND_50Cal_Suppressor"}, 0.1));
		loot_table.Insert(new ZLandLootWithAttachments({"ZLand_GM6LYNX"}, 0.01, {
			new ZLandLootEntry({"ZLand_Burris_RT6"}),
			new ZLandLootEntry({"ZLand_Burris_RT6"}),
			new ZLandLootWithAttachments({"ZLandGM6LYNX_Magazine"}, 1.0, {
			    new ZLandLootEntry({"Battery9V","APES_Mildot","APES_shinigamired","APES_Shinigami_V2_Red","APES_Shortdotred","APES_Hunting_Red","Connor_Vortex3","ZLandGM6LYNX_Magazine"}),
			}),
		}));
		loot_table.Insert(new ZLandLootEntry({"ZLand"}, 0));
		loot_table.Insert(new ZLandLootWithAttachments({"PITSTOP_M82A2_Black"}, 0.01, {
			...
			new ZLandLootWithAttachments({"PITSTOP_M82A2_Magazine"}, 1.0, {
			    new ZLandLootEntry({"Battery9V","APES_Mildot","APES_shinigamired","APES_Shinigami_V2_Red","APES_Shortdotred","Connor_Vortex3","PITSTOP_M82A2_Magazine"}),
			}),
		}));
		loot_table.Insert(new ZLandLootEntry({"ZLand"}, 0));
		loot_table.Insert(new ZLandLootWithAttachments({"ZLand_VSSK"}, 1.0, {
			...
			new ZLandLootWithAttachments({"ZLand_VSSK_Mag_5rnd"}, 1.0, {
			    new ZLandLootEntry({"Battery9V","Connor_Vortex3","APES_shinigamired","APES_Shinigami_V2_Red","APES_Shortdotred","APES_Hunting_Red","ZLand_VSSK_Mag_5rnd"}),
			}),
		}));
		loot_table.Insert(new ZLandLootEntry({"ZLand"}, 0));
		loot_table.Insert(new ZLandLootWithAttachments({"Connor_Anzio"}, 0.01, {
			...
			new ZLandLootWithAttachments({"PITSTOP_Ammo_65cal"}, 1.0, {
			    new ZLandLootEntry({"Battery9V","Connor_Vortex3","APES_shinigamired","APES_Shinigami_V2_Red","APES_Shortdotred","APES_Hunting_Red","PITSTOP_Ammo_65cal"}),
			}),
		}));
		loot_table.Insert(new ZLandLootEntry({"ZLand"}, 0));
		...
		loot_table.Insert(new ZLandLootEntry({"IMP_Supp_408_Black"}, 1.0));
		loot_table.Insert(new ZLandLootWithAttachments({"IMP_M98B"}, 0.7, {
			new ZLandLootEntry({"ZLand_Burris_RT6"}),
			new ZLandLootEntry({"ZLand_Burris_RT6"}),
			new ZLandLootWithAttachments({"IMP_Mag_M98B_10Rnd"}, 1.0, {
			    new ZLandLootEntry({"Battery9V", "Connor_Vortex3","Connor_Bravo","Connor_Burris","Connor_Holosun","Connor_PK06","Connor_Romeo3","Connor_Spitfire","ZLand_Hamr","ZLand_DeltaPoint","IMP_Mag_M98B_10Rnd"}),
			}),
		}));
		loot_table.Insert(new ZLandLootEntry({"ZLand"}, 0));
		...
		loot_table.Insert(new ZLandLootEntry({"ZLand"}, 0));
		loot_table.Insert(new ZLandLootWithAttachments({"ZLand_MCX_Spear"}, 0.5, {
			new ZLandLootEntry({"VTR_bravo4","ZLand_DeltaPoint","Connor_Bravo","Connor_Burris","Connor_Elcan","Connor_PK06","Connor_TrijiconMRO"}),
			new ZLandLootEntry({"VTR_bravo4","ZLand_DeltaPoint","Connor_Bravo","Connor_Burris","Connor_Elcan","Connor_PK06","Connor_TrijiconMRO"}),
		...
		loot_table.Insert(new ZLandLootEntry({"ZLand"}, 0));
		loot_table.Insert(new ZLandLootWithAttachments({"ZLand_DesertTechHTI_Black"}, 0.5, {
			new ZLandLootEntry({"ZLand_Burris_RT6"}),
			new ZLandLootEntry({"ZLand_Burris_RT6"}),
