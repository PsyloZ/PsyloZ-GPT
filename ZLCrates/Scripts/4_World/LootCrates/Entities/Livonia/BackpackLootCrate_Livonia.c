class BackpackLootCrate_Livonia: ZLandContainerBase
{
	override void RegisterLootTable(array<ref ZLandLootEntry> loot_table) 
	{
		...
		loot_table.Insert(new ZLandLootEntry({"bbp_blueprint", "ZLAND_Flag", "CodeLock", "NailBox", "Mosin_Compensator", "MP5_Compensator", "ZLandCompensator_JCOMP", "sodacan_cola", "sodacan_kvass", "sodacan_pipsi", "sodacan_spite", "sodacan_fronta", "SodaCan_Budweiser", "SodaCan_Guiness", "SodaCan_Ironbru", "SodaCan_Sanmiguel", "SodaCan_Stella", "vodka", "waterbottle"}, 1.0));
		loot_table.Insert(new ZLandLootWithAttachments({"ZLand"}, 0, {
		...
		loot_table.Insert(new ZLandLootEntry({"ZLAND_SprayPaint_Black", "ZLAND_SprayPaint_Green", "ZLand_Shotgun_Suppressor", "PistolSuppressor", "PITSTOP_UniversalSuppressor_Black", "ZLand_Suppressor_Black", "crackers", "saltysticks", "rice", "spaghettican", "peachescan", "bakedbeanscan", "pajka", "pate", "zagorkychocolate", "tacticalbaconcan", "brisketspread", "catfoodcan", "dogfoodcan", "honey", "porkcan", "ZLAND_Doritos_Coolranch", "ZLAND_Doritos_Nachocheese"}, 1.0));
		loot_table.Insert(new ZLandLootWithAttachments({"ZLand"}, 0, {
	...
	{
		EffectSound sound =	SEffectManager.PlaySound( "bagOpen_SoundSet", GetPosition() );
